module.exports = function (grunt) {
  var _ = grunt.util._;
  var locales = ["bg", "ca", "cs", "de", "es", "es_419", "fr", "fa", "hu", "it", "lo", "lt", "nl", "pl", "pt", "ru", "sl", "zh_CN"];
  var jsfiles = [
    "src/sao.js",
    "src/rpc.js",
    "src/pyson.js",
    ...
    shell: {
      ...
      msgmerge: {
        command: _.map(locales, function (locale) {
          ...
          return "msgmerge " + "-U " + po + " " + "--no-location " + "locale/messages.pot;";
        }).join(""),
      },
      xgettext: {
        command:
          "xgettext " + "--language=JavaScript --from-code=UTF-8 " + "--omit-header --no-location " + "-o locale/messages.pot " + jsfiles.join(" "),
      },
    },
    po2json: {
      options: {
